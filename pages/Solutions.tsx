      ...
      <div className="space-y-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
                <div className="w-14 h-14 bg-red-100 rounded-2xl flex items-center justify-center text-red-900 mb-6">
                    <Rocket size={28} />
                </div>
                ...
                <ul className="space-y-4 mb-8">
                    {['SOC2 Ready Infrastructure', 'Affordable scaling plans', 'Zero-setup collaboration'].map((item, i) => (
                        <li key={i} className="flex items-center gap-3 text-slate-700 font-medium">
                            <div className="w-5 h-5 rounded-full bg-red-100 flex items-center justify-center text-red-900">
            ...
            <div className="order-1 md:order-2 bg-gradient-to-br from-red-50 to-slate-50 border border-slate-200 rounded-3xl h-[400px] relative overflow-hidden flex items-center justify-center">
