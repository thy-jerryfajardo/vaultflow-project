      ...
      <div className="max-w-5xl mx-auto bg-slate-900 rounded-[2.5rem] p-12 md:p-24 text-center relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
            Join thousands of teams who trust SunnSafe for their most critical data.
            Start your free trial today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
                onClick={onOpenAuth}
                className="px-10 py-4 bg-red-900 text-white rounded-full font-bold text-lg hover:bg-red-800 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-red-900/30 flex items-center gap-2"
            >
                Get Started Free
                <ArrowRight size={20} />
            </button>
