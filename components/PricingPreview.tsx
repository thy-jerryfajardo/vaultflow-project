        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="p-8 bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow flex flex-col">
            ...
            <div className="space-y-3 mb-8 flex-1">
               <div className="flex items-center gap-2 text-sm text-slate-600"><Check size={16} className="text-red-900"/> 5 GB Storage</div>
          ...
          <div className="p-8 bg-slate-900 rounded-3xl border border-slate-800 shadow-xl relative overflow-hidden group flex flex-col transform md:-translate-y-4">
            ...
            <div className="mb-4 relative z-10">
               <div className="flex justify-between items-start">
                  ...
                  <span className="bg-red-900 text-white text-[10px] font-bold px-2 py-1 rounded-full uppercase tracking-wider">Popular</span>
               </div>
            ...
            <p className="text-sm text-slate-400 mb-6 relative z-10">For growing teams.</p>
             <div className="space-y-3 mb-8 relative z-10 flex-1">
               <div className="flex items-center gap-2 text-sm text-slate-300"><Check size={16} className="text-red-800"/> 1 TB Storage</div>
               <div className="flex items-center gap-2 text-sm text-slate-300"><Check size={16} className="text-red-800"/> Advanced Roles</div>
          ...
          {/* Business */}
           <div className="p-8 bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow flex flex-col">
            ...
            <p className="text-sm text-slate-500 mb-6">For large organizations.</p>
             <div className="space-y-3 mb-8 flex-1">
               <div className="flex items-center gap-2 text-sm text-slate-600"><Check size={16} className="text-red-900"/> Unlimited Storage</div>
