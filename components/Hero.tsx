...
const Hero: React.FC<HeroProps> = ({ onOpenAuth, onNavigate }) => {
  ...
  return (
    <section className="relative pt-48 pb-40 px-6 flex flex-col items-center justify-center text-center max-w-7xl mx-auto min-h-[90vh]">
      ...
      {/* Badge */}
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-50 border border-red-100 mb-10 hover:bg-red-100/50 hover:border-red-200 transition-all cursor-default animate-in fade-in slide-in-from-bottom-4 duration-700 shadow-sm group">
        <span className="flex h-2 w-2 rounded-full bg-red-500 animate-pulse"></span>
        <span className="text-[11px] font-bold text-red-800 tracking-widest uppercase group-hover:text-red-900">
      ...
      <h1 className="max-w-5xl text-5xl md:text-7xl font-extrabold tracking-tight text-slate-950 mb-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100 leading-[1.15]">
        ...
        <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-red-900 via-red-800 to-red-900 bg-[length:200%_auto] animate-[pulse_5s_ease-in-out_infinite] pb-2">
          modern teams
        </span>
      </h1>
      ...
      <div className="w-full flex justify-center mb-24 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 min-h-[56px] relative z-20">
        ...
        {loading ? (
          <div className="flex items-center justify-center w-full sm:w-auto px-12 py-3">
             <Loader2 className="w-6 h-6 text-red-900 animate-spin opacity-50" />
          </div>
        ) : user ? (
          ...
          <div className="bg-white/70 backdrop-blur-xl border border-white/40 ring-1 ring-slate-200 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.1)] p-8 rounded-3xl flex flex-col items-center gap-6 max-w-lg w-full animate-in zoom-in-95 duration-500 hover:shadow-[0_25px_50px_-12px_rgba(16,185,129,0.15)] transition-all">
            <div className="text-center space-y-2">
                <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <span className="text-[10px] font-bold text-red-700 uppercase tracking-widest">Active Session</span>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full">
                <button
                    ...
                    className="flex-1 px-6 py-3.5 rounded-xl text-white font-bold shadow-lg shadow-red-200 hover:shadow-red-300 hover:-translate-y-0.5 transition-all duration-300 bg-gradient-to-r from-red-900 to-red-800 flex items-center justify-center gap-2"
                >
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <button
              onClick={onOpenAuth}
              className="w-full sm:w-auto px-10 py-4 rounded-full text-white font-bold shadow-[0_4px_14px_0_rgba(127,29,29,0.39)] hover:shadow-[0_6px_20px_rgba(127,29,29,0.23)] hover:-translate-y-1 transition-all duration-500 bg-red-900 flex items-center justify-center gap-2 group active:scale-95 text-base"
            >
              Get Started Free
            ...
            >
              <PlayCircle className="w-5 h-5 text-red-900 group-hover:scale-110 transition-transform" />
              Live Demo (No Login)
            </button>
          </div>
        )}
